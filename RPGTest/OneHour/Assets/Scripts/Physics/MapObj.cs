...
public class MapObj : PhysicNode {
    ...
    public virtual void InitB2Rectangle(MapWorld mapBase, float width, float height, float density, Vector2 position = new Vector2(), float rotation = 0, BodyType bodyType = BodyType.Static, short collisionId = 0, bool isActive = true)
    {
        curMap = mapBase;
    ...
    public virtual void InitB2Circle(MapWorld mapBase, float radius, float density, Vector2 position = new Vector2(), BodyType bodyType = BodyType.Static, short collisionId = 0, bool isActive = true)
    {
        curMap = mapBase;
    ...
    public virtual void InitB2Polygon(MapWorld mapBase, List<Vector2> points, float density, Vector2 position = new Vector2(), float rotation = 0, BodyType bodyType = BodyType.Static, short collisionId = 0, bool isActive = true)
    {
        curMap = mapBase;
        if (points == null)
        {
