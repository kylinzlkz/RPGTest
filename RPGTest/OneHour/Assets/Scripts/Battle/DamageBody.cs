...
public class DamageBody : MonoBehaviour {
    ...
    /// </summary>
    /// <returns></returns>
    public bool InitDamage(BaseRole host, string handleName, int skillId, DamageBodyInfo node)
    {
        ...
        m_fVelocityX = m_damageBodyInfo.VelocityX;
        m_fVelocityY = m_damageBodyInfo.VelocityY;
