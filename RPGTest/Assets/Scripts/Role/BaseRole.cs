...
public class BaseRole : MonoBehaviour {
    ...
    /// <summary>
    /// 当DirX=0 且 DirY=0 则设置DirY为-1 （默认朝向屏幕，即下方）
    /// </summary>
    public void JudgeDir()
    {
        if (m_iDirX == 0 && m_iDirY == 0)
            m_iDirY = -1;
    }
    ...
    {
        m_iDirX = 1;
        m_mapRole.SetCurVelocityX(m_iDirX, m_baseInfo.VelocityX);
        return true;
    }
    ...
    public bool StopHorizontal()
    {
        m_iDirX = 0;
        //JudgeDir();
        m_mapRole.SetCurVelocityX(m_iDirX, 0);
        return true;
    }
    public bool RunUp()
    {
        m_iDirY = 1;
        m_mapRole.SetCurVelocityY(m_iDirY, m_baseInfo.VelocityY);
        return true;
    }
    ...
    public bool StopVertical()
    {
        m_iDirY = 0;
        //JudgeDir();
        m_mapRole.SetCurVelocityY(m_iDirY, 0);
        return true;
    }
    ...
    public bool Attack1()
    {
        ...
        {
            DamageBodyManager.Instance.TestAddDamageBody(this, m_iDirX, m_iDirY);
        }
        return true;
    }
